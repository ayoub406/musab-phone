...
تطبيق ويب باستخدام Flask + PostgreSQL
"""
...
QR_DIR = os.path.join(os.path.dirname(**file**), "static", "qrcodes")
...
# إعدادات دخول لوحة التحكم

# ---------------------------------------------------------

ADMIN_USERNAME = "admin"
ADMIN_PASSWORD = "musab2026"
...
SALES_PHONE = "0922051000"
MAINTENANCE_PHONE = "0942051000"
...
# إضافة custom_request إذا لم يكن موجوداً
if not _column_exists(conn, "reservations", "custom_request"):
    conn.execute(
        """
        ALTER TABLE reservations
        ADD COLUMN custom_request TEXT
        """
    )
...
percent = (
    round((reserved / TOTAL_STOCK) * 100)
    if TOTAL_STOCK
    else 0
)
...
"""
يبني قائمة الألوان مع عدد الحجوزات
ويحدد اللون الأكثر مبيعاً.
"""
...
"ar": {
    ...
    "hero_title_pre": "احجز جهازك",
    "hero_title_high": "iPhone 18",
    "hero_title_post": "قبل أي أحد آخر",

    "hero_sub": "مصعب فون يقدّم لك فرصة الحجز المسبق لأحدث إصدار من آيفون بأفضل الأسعار وأولوية استلام فور توفر الجهاز.",

    "hero_cta1": "احجز جهازك الآن",
    "hero_cta2": "تصفح منتجات آبل الجديدة",
    ...
    "stock_remaining": "متبقي",
    "stock_of": "من",
    "stock_device": "جهاز",
    "stock_percent_note": "من الكمية تم حجزها",
    "stock_soldout": "نفدت الكمية بالكامل! الحجز مغلق الآن.",

    "growth_title": "نمو الحجوزات لحظة بلحظة",
    "growth_sub": "الخط يرتفع مباشرة مع كل عملية حجز جديدة",
    "growth_label": "📈 إجمالي الحجوزات حتى الآن",

    "features_title": "لماذا تحجز عبر مصعب فون؟",
    "features_sub": "نوفر لك تجربة حجز موثوقة وسريعة وآمنة",

    "f1_title": "أولوية الاستلام",
    "f1_desc": "كن من أوائل من يستلم جهاز آيفون 18 فور وصوله للمتجر.",

    "f2_title": "حجز آمن 100%",
    "f2_desc": "بياناتك محمية بالكامل، ولا يتم أي خصم مالي عند الحجز.",

    "f3_title": "دعم فوري",
    "f3_desc": "فريق مصعب فون جاهز للرد على استفساراتك في أي وقت.",

    "f4_title": "أفضل الأسعار",
    "f4_desc": "أسعار تنافسية وعروض حصرية للحاجزين الأوائل فقط.",

    "gallery_title": "اختر لونك المفضل",
    "gallery_sub": "iPhone 18 متوفر بخمسة ألوان مميزة",
    "gallery_sold_label": "حجز حتى الآن",
    "gallery_bestseller": "🏆 الأكثر مبيعاً",
    ...
    "price_tbd": "السعر يُعلن قريباً 🔔",
    "popular_badge": "الأكثر طلباً",
    "book_this_model": "احجز هذا الموديل",

    "vip_title": "✨ طلب VIP خاص",
    "vip_sub": "صمّم جهازك بنفسك",
    ...
    "reserve_sub": "عبّئ بياناتك وسيتواصل معك فريقنا لتأكيد الحجز",
    ...
    "label_model": "الموديل *",
    "label_color": "اللون *",
    "label_storage": "سعة التخزين *",
    "label_notes": "ملاحظات إضافية",
    "label_custom_request": "تفاصيل التصميم الخاص (VIP) *",

    "ph_name": "مثال: مصعب أحمد",
    "ph_phone": "09xxxxxxxx",
    "ph_email": "example@email.com",
    "ph_city": "مدينتك",
    "ph_choose_model": "اختر الموديل",
    "ph_choose_color": "اختر اللون",
    "ph_choose_storage": "اختر السعة",
    "ph_notes": "أي تفاصيل إضافية ترغب بإخبارنا بها",
    ...
    "footer_maintenance": "قسم الصيانة",
    "footer_whatsapp": "تواصل واتساب",
...
"en": {
    ...
    "hero_title_pre": "Reserve your",
    "hero_title_high": "iPhone 18",
    "hero_title_post": "before anyone else",
    ...
    "hero_cta1": "Reserve now",
    "hero_cta2": "Browse Apple's new products",
    ...
    "growth_title": "Live booking growth",
    "growth_sub": "The line rises instantly with every new booking",
    "growth_label": "📈 Total bookings so far",

    "features_title": "Why book with Musab Phone?",
    "features_sub": "A reliable, fast and secure booking experience",

    "f1_title": "Priority pickup",
    "f1_desc": "Be among the first to receive iPhone 18 as soon as it arrives.",

    "f2_title": "100% secure booking",
    "f2_desc": "Your data is fully protected, no charge is taken at booking time.",

    "f3_title": "Instant support",
    "f3_desc": "The Musab Phone team is ready to answer your questions anytime.",

    "f4_title": "Best prices",
    "f4_desc": "Competitive prices and exclusive offers for early bookers.",

    "gallery_title": "Pick your favorite color",
    "gallery_sub": "iPhone 18 comes in five stunning colors",
    "gallery_sold_label": "booked so far",
    "gallery_bestseller": "🏆 Best seller",
    ...
    "price_tbd": "Price to be announced 🔔",
    "popular_badge": "Most popular",
    "book_this_model": "Book this model",

    "vip_title": "✨ VIP Custom Order",
    "vip_sub": "Design your own device",
    ...
    "reserve_title": "Booking form",
    "reserve_sub": "Fill in your details and our team will contact you to confirm the booking",
    ...
    "ph_name": "e.g. Musab Ahmed",
    "ph_phone": "09xxxxxxxx",
    "ph_email": "example@email.com",
    "ph_city": "Your city",
    "ph_choose_model": "Choose a model",
    "ph_choose_color": "Choose a color",
    "ph_choose_storage": "Choose storage",
    "ph_notes": "Any extra details you'd like us to know",
    ...
    "footer_maintenance": "Support line",
...
"""
يعيد توليد QR إذا كانت الصورة غير موجودة.
"""
...
def index():
    ...
    return render_template(
        ...
        deadline_readable=RESERVATION_DEADLINE.strftime(
            "%Y-%m-%d %I:%M %p"
        ),
...
def reserve():
    ...
    custom_request = request.form.get(
        "custom_request",
        ""
    ).strip()
    ...
    if stock["sold_out"]:
        errors.append(
            "عذراً، نفدت كامل الكمية المتاحة للحجز."
            if is_ar
            else "Sorry, we are sold out."
        )

    if len(full_name) < 3:
        errors.append(
            "الرجاء إدخال الاسم الكامل بشكل صحيح."
            if is_ar
            else "Please enter a valid full name."
        )
    ...
    if not m:
        errors.append(
            "الرجاء اختيار موديل الجهاز."
            if is_ar
            else "Please choose a device model."
        )

    if m and color not in m["colors"]:
        errors.append(
            "الرجاء اختيار لون متاح لهذا الموديل."
            if is_ar
            else "Please choose a color available for this model."
        )

    if m and storage not in m["storages"]:
        errors.append(
            "الرجاء اختيار سعة تخزين متاحة لهذا الموديل."
            if is_ar
            else "Please choose a storage option available for this model."
        )

    if m and m.get("is_vip") and len(custom_request) < 5:
        errors.append(
            "الرجاء وصف تصميمك الخاص (VIP)."
            if is_ar
            else "Please describe your custom VIP design."
        )

    if datetime.now() > RESERVATION_DEADLINE:
        errors.append(
            "عذراً، انتهى وقت استقبال الحجوزات."
            if is_ar
            else "Sorry, the booking window has closed."
        )
    ...
    # -------------------------------------------------
    # PostgreSQL:
    # استخدم RETURNING id بدل lastrowid
    # -------------------------------------------------
    cur = conn.execute(
        """
    ...
    flash(
        (
            "تم استلام حجزك بنجاح! سيتم التواصل معك قريباً من فريق "
            + COMPANY_NAME
            + "."
        )
        if is_ar
        else "Your booking was received! Our team will contact you soon.",
        "success",
    )
...
# -------------------------------------------------------
# استرجاع الحجوزات عن طريق الهاتف
# -------------------------------------------------------
...
def api_deadline():
    return jsonify(
        {
            "deadline_iso":
                RESERVATION_DEADLINE.isoformat()
        }
    )
...
def admin():
    ...
    for row in rows:
        ...
        st = (
            row["status"]
            if row["status"] in VALID_STATUS_IDS
            else "pending"
        )
...
def admin_add_category():
    ...
    return redirect(
        url_for("admin_catalog")
    )


@app.route(
    "/admin/categories/delete/<int:cat_id>",
    methods=["POST"]
)
...
@app.route(
    "/admin/products/delete/<int:prod_id>",
    methods=["POST"]
)
...
@app.route(
    "/admin/products/toggle/<int:prod_id>",
    methods=["POST"]
)
